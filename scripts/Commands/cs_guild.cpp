...
public:
    ...
    ChatCommand* GetCommands() const override
    {
        static ChatCommand guildCommandTable[] =
        {
			...
			{ "reloadxp", rbac::RBAC_PERM_COMMAND_GUILD_RELOAD_XP,true, &HandleGuildReloadXPCommand,         "", NULL },
	...
	static bool HandleGuildReloadXPCommand(ChatHandler* handler, char const* /*args*/)
	{
		Guild* guild = handler->getSelectedPlayerOrSelf()->GetGuild();
		if (guild)
		{
			guild->LoadLevelInfo();
			guild->LoadTalentsInfo();
		}
		return true;
	}
};
