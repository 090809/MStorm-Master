...
enum CharacterDatabaseStatements
{
    ...
    */
	...
	CHAR_SEL_ROYAL_GUILD,
	CHAR_UPD_GUILD_LEVEL,
	CHAR_UPD_GUILD_XP,

	CHAR_UPDATE_BGS_ITEMS_TO_BACKUP,
	CHAR_UPDATE_BGS_ITEMS_TO_BACKUP_DELETE,

	CHAR_SEL_BG_CHANGES,
	//Маунты привязанные к аккаунту
	CHAR_INS_LEARNED_MOUNTS,
	CHAR_SEL_LEARNED_MOUNTS,
