...
enum WorldIntConfigs
{
	...
	CONFIG_MODIFIER_ONLINE_CHARACTERS_ITEM_ID,
	CONFIG_MODIFIER_ONLINE_CHARACTERS_ITEM_COUNT,
	...
	CONFIG_BG_REWARD_ID,
	CONFIG_BG_REWARD_WIN_COUNT,
	CONFIG_BG_REWARD_LOSE_COUNT,

	CONFIG_ARENA_1V1_MIN_LEVEL,
	CONFIG_ARENA_1V1_COSTS,

	CONFIG_GOLD_PLAG_GOLD_COUNT,

	CONFIG_LAST_BOSS_REWARD_POINT_MINIMUM_PLAYERS,
	CONFIG_LAST_BOSS_REWARD_POINT_NEWBEE,
	CONFIG_LAST_BOSS_REWARD_POINT_PRO,
	CONFIG_LAST_BOSS_REWARD_POINT_ID,
	CONFIG_LAST_BOSS_REWARD_POINT_BIGGEST,
	CONFIG_LAST_BOSS_REWARD_POINT_LOWEST,
...
class World
{
    public:
		...
		int GetMaxGuildLevel() const { return _maxGuildLevel; }
        void KickAll();
        ...
        void ReloadRBAC();
		GuildTalentsSystem* GetGuildTalentsSystem() { return _GuildTalentsSystem; }
    protected:
    ...
    private:
		...
		//Guild-Level-System
		uint8 m_req_guildLevel_bon_gold_1;
		uint8 m_req_guildLevel_bon_gold_2;
		uint8 m_req_guildLevel_bon_gold_3;
        
		uint8 m_req_guildLevel_bon_honor_1;
		uint8 m_req_guildLevel_bon_honor_2;
		uint8 m_req_guildLevel_bon_honor_3;

		uint8 m_req_guildLevel_bon_ap_1;
		uint8 m_req_guildLevel_bon_ap_2;
		uint8 m_req_guildLevel_bon_ap_3;

		uint8 m_req_guildLevel_bon_guid_gold_1;
		uint8 m_req_guildLevel_bon_guid_gold_2;
		uint8 m_req_guildLevel_bon_guid_gold_3;

		uint8 m_req_guildLevel_badjes_1;
		uint8 m_req_guildLevel_badjes_2;
		uint8 m_req_guildLevel_badjes_3;

		uint8 m_req_guildLevel_badjes_x2_1;
		uint8 m_req_guildLevel_badjes_x2_2;
		uint8 m_req_guildLevel_badjes_x2_3;
		GuildTalentsSystem* _GuildTalentsSystem;
};
