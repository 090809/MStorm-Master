...
enum AuraType
{
    ...
    SPELL_AURA_MOD_ADDITIONAL_MONEY_PCT                     = 63,   // Дополнительное золото
	...
	SPELL_AURA_FREE_FOR_MOVE								= 90,   // Спелы, которые можно юзать на ходу (в MiscValue ID)
    ...
    SPELL_AURA_MOD_FREE_FOR_ALL_LOOT_PCT                    = 164,
    ...
    SPELL_AURA_SWITCH_LEGENDARY_SPELLS                      = 173,  // old SPELL_AURA_ALLOW_CHAMPION_SPELLS //HandleAuraLearnLegendarySpell
