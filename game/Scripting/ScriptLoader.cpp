...
//kalimdor            
void AddSC_boss_asgur(); //Blackfathom Depths
...
{
#ifdef SCRIPTS
	AddSC_boss_asgur(); //Blackfathom Depths
	AddSC_boss_dionis();
	AddSC_boss_kraken();
	AddSC_boss_zibun();
...
void AddCustomScripts()
{
	...
	AddSC_start_event_scr();
	AddSC_player_learnspell();
	AddSC_DuelReset();
	AddSC_player_account_mounts();
	AddSC_PWS_Transmogrification();
	AddSC_CS_Transmogrification();
	AddSC_npc_1v1arena();
	AddSC_boss_dead_palladin();
	AddSC_maiev_in_madness();
	AddSC_instance_t5();
	AddSC_boss_necromancers();
	AddSC_Shadow_Mother_Shahraz();
	AddSC_npc_guild_level_master();
	AddSC_Challenge_Survive();
	AddSC_new_KilDjaden();
