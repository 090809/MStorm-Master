...
struct BGItems {
	uint32 SavedItemID, SavedItemGUID;
};
...
class Player : public Unit, public GridObject<Player>
{
    ...
    public:
		...
		void SetVIP(int32 timeto) { m_VIP = true; m_VIP_timeto = timeto; }
		void RemoveVIP() { m_VIP = false; }
		...
		void ChangeEquipToHighLevelIfNeed(bool arena);
		void ChangeBackItems();
		void LearnGuildSpells();
		bool CheckForHimari(Player* player);

		//@todo - вынести это к чертям собачим отсюда.
		struct ItemChengerArray
		{
			uint32 id_1, id_2, id_3, id_4, id_5, id_6, id_7, id_8, id_9, id_10, ToChange;
			int Class, Position;
			bool ArenaOnly;
			uint32 operator[](int idx) {
				switch (idx)
				{
				case 1: return id_1;
				case 2: return id_2;
