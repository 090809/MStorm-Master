...
WintergraspBuildingSpawnData const WGGameObjectBuilding[WG_MAX_OBJ] =
{
    ...
    // Wall (with passage) (Not spawned in db) 3
    ...
    // South tower (Not spawned in db) 3
...
public:
	...
	void DefineID(uint32 id) { _ID = id; }
